...
const Sidebar = () => {
  ...
  return (
    <aside className="bg-gray-300 col-span-2 min-h-screen sticky">
      <div className="text-white text-center font-bold text-xl h-12 flex items-center px-4 lg:px-5 my-1">
        {/* <div className="flex justify-between gap-5">
          <img className="w-[30px] h-[30px] rounded-full shrink-0" src="https://i.ibb.co/VMk1CZQ/images.jpg" alt="" />
          <h1 className="uppercase truncate">Joyanti</h1>
        </div> */}
      </div>
      <hr />
      <nav className="flex flex-col gap-2 px-4 lg:px-5 py-1 mt-5">
        <NavLink
          ...
          className={({ isActive }) =>
            cn(
              "p-2  bg-gray-500 text-white rounded-md transition-all flex gap-2 items-center",
              {
